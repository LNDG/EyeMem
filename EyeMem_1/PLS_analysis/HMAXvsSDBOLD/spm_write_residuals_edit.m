function VRes = spm_write_residuals_edit(SPM,Ic)
...
try, cd(SPM.swd); catch, SPM.swd = pwd; end
cwd = pwd; cd(SPM.swd);
...
for i=1:nbchunks
    ...
    for j=1:nScan
%       SPM.xY.VY(j).fname = ['/Users/kloosterman/gridmaster2012/' SPM.xY.VY(j).fname(24:end)];
