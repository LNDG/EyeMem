...
DATADIR=${RootPath}/projectdata/eyemem/variability
...
for subj in $subjList; do
	...
	echo "/home/mpib/kloosterman/MATLAB/tools/spm12/../standalone/run_spm12.sh /opt/matlab/R2016b run ${DATADIR}/5TRspertrial/jobs/${subj}_5TRspertrial_sdmodel.mat" 		>> job
...
# /home/mpib/kloosterman/MATLAB/tools/spm12/../standalone/run_spm12.sh /opt/matlab/R2016b run /home/beegfs/kloosterman/projectdata/eyemem/variability/singletrial_5sres/jobs/sub-09_singletrial_5sres_sdmodel.mat